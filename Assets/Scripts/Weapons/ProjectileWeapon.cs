...
public class ProjectileWeapon : BaseWeapon
{
    ...
    private void SpawnProjectile()
    {
        ...
        GameObject projectile = _projectilePool.Get(_shootPoint.position, spawnRotation);

        Projectile projectileComponent = projectile.GetComponent<Projectile>();
        projectileComponent.Initialize(_damage, _projectileSpeed, spawnRotation * Vector3.right, _targetLayers, _projectilePool);
